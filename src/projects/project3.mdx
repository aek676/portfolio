...
description: "Implementación del algoritmo PageRank de Google en Rust, demostrando como las cadenas de Markov y el modelo de teletransporte permiten clasificar páginas web según su relevancia."
